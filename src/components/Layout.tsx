                ...
                <div className="flex h-full flex-col p-8">
                    <div className="mb-12 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-bold text-black/30 uppercase tracking-[0.2em] mt-1">
                                OS Edition
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-auto pt-8">
                        <div className="rounded-4xl bg-black/[0.03] p-6 border border-black/[0.02]">
                            <p className="text-[10px] font-black text-black/20 uppercase tracking-[0.3em] mb-2">
                                Developed By
                            </p>
                            <p className="text-sm font-extrabold">ZIKNYAWDEV</p>
                        </div>
                    </div>
                </div>
            </aside>
