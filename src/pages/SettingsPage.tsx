...
export default function SettingsPage() {
    ...
    const handleImport = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onload = async e => {
            try {
                ...
                if (
                    confirm(
                        "Mengimpor data akan menghapus data saat ini. Lanjutkan?"
                    )
                ) {
                ...
                showToast(
                    "Gagal mengimpor data. Pastikan file JSON valid.",
                    "error"
                );
                console.error(error);
            }
    ...
    const handleClearData = async () => {
        if (
            confirm(
                "PERINGATAN: Semua data akan dihapus permanen. Tindakan ini tidak dapat dibatalkan. Hapus semua data?"
            )
        ) {
    ...
    return (
        <div className="space-y-12 max-w-4xl mx-auto">
            ...
            <header>
                <p className="text-[10px] font-black text-black/20 uppercase tracking-[0.5em] mb-2">
                    System
                </p>
                ...
                <section className="os-card p-10">
                    <div className="mb-10 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-black/20 uppercase tracking-[0.2em] mt-1">
                    ...
                    <div className="space-y-8 relative z-10">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-xs font-bold text-black/30 uppercase tracking-[0.3em]">
                                    Version 2.0.26 • OS Theme
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 pt-8 border-t border-black/[0.03]">
                            <div className="flex items-center justify-between">
                                <p className="text-xs font-black text-black/20 uppercase tracking-widest">
                                    Developer
                                </p>
